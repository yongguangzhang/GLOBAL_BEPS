...
__device__ void gpureadb_init(float b[]) 
{
	...
	b[4]=0.0003/RTIMES;     /* b(4) Ppt Interception co. m lai-1 d-1 */   //原为：0.0005
	
	b[6]=0.001/RTIMES;		/* b(6) Snowmelt Temp coeff.  */
	b[7]=0.50/RTIMES;		/* b(7) water aborption */

	b[8]=1.0;//0.12/RTIMES; 		/* b(8) Snowmelt Rad coeff.  */
	...
	b[28]=2.3;				/* b(28) Q10: constant for exp. resp. for stem	*/   //2013年6月28日由1.5改为2.3
	b[29]=2.3;				/* b(29) Q10: constant for exp. resp. for root	*/   //2013年6月28日由1.9改为2.3
